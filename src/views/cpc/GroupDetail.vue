    ...
    <div class="group-detail-page">
      ...
      <div class="detail-body">
        ...
        <div class="detail-content">
          ...
          <GroupTargets v-else-if="activeMenu === 'targets'" :shop-id="shopId" :campaign-id="campaignId" :ad-group-id="adGroupId" />
...
import { getCpcGroup, updateCpcGroup } from '@/services/cpc'
...
onMounted(() => { if (shopId.value) loadGroupInfo() })
</script>
